...
#include<ctime>
#include <wiringPi.h>
#include <stdlib.h>#include <softTone.h>
#include <time.h>
#include <fstream>
#include <vector>
...
int main()
{
	...
	pullUpDnControl (6, PUD_UP);	//Green Button Pull Up Resistor
	pullUpDnControl (16, PUD_UP);	//Red Button
	pullUpDnControl (12, PUD_UP);	//Blue Button
	pullUpDnControl (13, PUD_UP);	//Yellow Button
	pullUpDnControl (4, PUD_UP);	//Difficulty Button
	pullUpDnControl (18, PUD_UP);	//Start Button
	pullUpDnControl (23, PUD_UP);	//Last Button
	pullUpDnControl (24, PUD_UP);	//Longest Button
